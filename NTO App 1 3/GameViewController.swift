...
//    @IBOutlet weak var imageView: UIImageView!
    ...
    func showPlayerOptions() {
        ...
        let refreshAlert = UIAlertController(title: "Select Player", message: "Choose one. Game will stop when you lose and you can submit to leaderboard if you wish. Click back and return to game to play again", preferredStyle: UIAlertControllerStyle.Alert)
