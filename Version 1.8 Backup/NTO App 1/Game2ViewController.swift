...
class Game2ViewController: UIViewController, MFMessageComposeViewControllerDelegate {
    ...
    func showPlayerOptions() {
        ...
        var refreshAlert = UIAlertController(title: "Select Player", message: "Choose one. Game will stop when you lose and you can submit to leaderboard if you wish. Click back and return to game to change characters or tap to play again.", preferredStyle: UIAlertControllerStyle.Alert)
